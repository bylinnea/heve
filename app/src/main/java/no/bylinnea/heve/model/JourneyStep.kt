...
enum class StepType(
    ...
    INGREDIENTS("add ingredients", hasDuration = false, defaultMinutes = 0),
    KNEAD("knead", hasDuration = true, defaultMinutes = 8),
    PROOF("proof", hasDuration = true, defaultMinutes = 45),
